...
public class GlobalParams {
    ...
    public void initializeGlobalParams() {
        ...
        if ("Android".equals(platformName)) {
            udid = System.getProperty("udid", "2b3c4130");
            deviceName = System.getProperty("deviceName", "Android");
            params.setSystemPort(System.getProperty("systemPort", "10000"));
            params.setChromeDriverPort(System.getProperty("chromeDriverPort", "11000"));
        } else if ("iOS".equals(platformName)) {
            udid = System.getProperty("udid", "00008030-000A2C6A1AFB802E");
            deviceName = System.getProperty("deviceName", "iPhone SE");
            params.setWdaLocalPort(System.getProperty("wdaLocalPort", "10001"));
            params.setWebkitDebugProxyPort(System.getProperty("webkitDebugProxyPort", "11001"));
        } else {
            throw new IllegalStateException("Invalid Platform Name!");
